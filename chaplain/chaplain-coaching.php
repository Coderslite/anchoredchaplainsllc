...
$query = mysqli_query(
    ...
    "SELECT *
     FROM clients 
     WHERE program_applied = 'Chaplain Coaching' AND assigned_chaplain = '$chaplainId' AND status <> 'deleted'"
);
...
$expiredRenewalQuery = mysqli_query(
    ...
    "SELECT COUNT(*) AS expired 
     FROM clients 
     WHERE program_applied = 'Chaplain Coaching'
                ...
                <div class="card">
                    <div class="card-header card-no-border">
                        <div class="header-top">
                            <h4>Chaplain Coaching Registration</h4>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Add New Chaplain Coaching Client</h5>
            ...
            <form action="php/add_client.php" method="POST">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="program_applied" value="Chaplain Coaching">
                    <input type="hidden" name="route" value="chaplain-coaching">
