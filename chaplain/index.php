...
$totalClients = mysqli_fetch_assoc(mysqli_query(
    $con,
    "SELECT COUNT(*) AS total FROM clients WHERE status <> 'deleted' AND assigned_chaplain = '$chaplainId' AND $dateCondition"
))['total'];
                        ...
                        <div class="table-responsive custom-scrollbar">
                            <table class=" table" id="last-orders">
                                ...
                                <tbody>
                                    <?php 
                                    $count = 0;
                                    $query = mysqli_query($con,"SELECT * FROM clients WHERE status <> 'deleted' AND assigned_chaplain = '$chaplainId' ORDER BY id DESC LIMIT 5");
