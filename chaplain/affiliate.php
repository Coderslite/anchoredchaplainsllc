...
$query = mysqli_query(
    ...
    "SELECT *
     FROM clients 
     WHERE program_applied = 'Affiliate' AND assigned_chaplain = '$chaplainId' AND status <> 'deleted'"
);
...
$expiredRenewalQuery = mysqli_query(
    ...
    "SELECT COUNT(*) AS expired 
     FROM clients 
     WHERE program_applied = 'Affiliate'
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Add New Affiliate Client</h5>
            ...
            <form action="php/add_client.php" method="POST">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="program_applied" value="Affiliate">
                    <input type="hidden" name="route" value="affiliate">
