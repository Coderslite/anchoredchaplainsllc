...
$query = mysqli_query(
    ...
    "SELECT *
     FROM clients 
     WHERE program_applied = 'Chaplain Training' AND assigned_chaplain = '$chaplainId' AND status <> 'deleted'"
);
...
$expiredRenewalQuery = mysqli_query(
    ...
    "SELECT COUNT(*) AS expired 
     FROM clients 
     WHERE program_applied = 'Chaplain Training'
            ...
            <div class="col-xl-12 box-col-5 col-md-12 proorder-md-2 mb-4">
                <div class="card h-100">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0">Chaplain Training</h4>
                ...
                <div class="card">
                    <div class="card-header card-no-border">
                        <div class="header-top">
                            <h4>Chaplain Training Registration</h4>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Add New Chaplain Training Client</h5>
            ...
            <form action="php/add_client.php" method="POST">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="program_applied" value="Chaplain Training">
                    <input type="hidden" name="route" value="chaplain-training">
...
document.querySelectorAll('.delete-client-btn').forEach(btn => {
    btn.addEventListener('click', () => {
        if (confirm('Are you sure you want to delete this client?')) {
            window.location.href = 'php/delete_client.php?id=' + btn.dataset.id+'&route=chaplain-training';
        }
    });
});
</script>
