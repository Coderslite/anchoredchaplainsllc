...
<!-- Mirrored from techzaa.getappui.com/techmin/layouts/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Oct 2023 22:38:55 GMT -->
<head>
    <meta charset="utf-8" />
    <title>Log In | Parcek Delivery Logistics</title>
...
<body class="authentication-bg position-relative" style="height: 100vh;">
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    <div class="auth-brand p-4 text-center">
                                        ...
                                        <a class="logo-dark">
                                            <img src="../assets/images/logo.png" alt="dark logo" height="28">
                                        </a>
                                    </div>
                                    <div class="p-4 my-auto text-center">
                                        ...
                                        <!-- form -->
                                        <form action="php/login.php" method="POST" class="text-start">
                                            <div class="mb-3">
    ...
    <footer class="footer footer-alt fw-medium">
        <span class="text-dark">
            <script>document.write(new Date().getFullYear())</script> © Parcel PareceDeliveryLogistics
        </span>
    </footer>
